...
const getIdeaboxCount = async (role, employeeId) => {
    const sql = "SELECT COUNT(id) FROM ideabox WHERE assigned_to = ? OR submitted_by = ?";
...
const getDepartments = async () => {
    const sql = "SELECT id, department_name as departmentName FROM department ORDER by department_name";
